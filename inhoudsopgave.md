...
## **3. Hoe programma’s met Windows praten (API’s & Telemetry)**
...
## **8. Threads & Execution Context (zonder extreem low-level te worden)**
...
## **9. Handles & Toegangsrechten Begrijpen**
...
## **11. Windows Services & Persistence Mechanisms**
...
## **13. Logging, Telemetry & Sysmon/ETW Mapping**

13.1 Verschil tussen Windows logs & EDR telemetry
